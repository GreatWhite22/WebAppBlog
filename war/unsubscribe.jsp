...
<form>
	...
	<div>
	<a href=""><input type="submit" onclick="confirm('Sorry to see you go');" name="dsubmit" id="commentSubmit" value="Subscribe"></a>
	<a href="blog.jsp"><input type="submit" name="" id="commentSubmit" value="Cancel"></a>
	</div>
	</form>
	<%
	...
	if(firstName == null || lastName == null || emailAddress == null){}
		...
		Subscribe oldSubscriber = new Subscribe(firstName, lastName, emailAddress);
		ListIterator<Subscribe> subscribers = Email.listofsubscribers.listIterator();
		while(subscribers.hasNext()){
			Subscribe subscriber = subscribers.next();
			if(subscriber.getEmailAddress().equals(emailAddress)){
				Email.listofsubscribers.remove(subscriber);
				break;
			}
		}
	}
